...
class __TwigTemplate_a44e08b83c26235e3f51c8536aa83023 extends Template
{
    private $source;
    private $macros = [];
        ...
        echo "              </div>
          ...
          <div class=\"row mb-3\">
            <div class=\"offset-sm-2 col-sm-10 text-end\">
              <button type=\"button\" id=\"button-backup\" class=\"btn btn-success\"><i class=\"fas fa-upload\"></i> ";
        // line 52
...
";
    ...
    {
        return new Source("", "admin/view/template/tool/backup.twig", "/var/www/html/opencart/upload/admin/view/template/tool/backup.twig");
    }
}
