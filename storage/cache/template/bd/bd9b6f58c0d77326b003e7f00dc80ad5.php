...
class __TwigTemplate_d5b107358d31b0ef481fdfe31e7cbcf2 extends Template
{
    private $source;
    private $macros = [];
...
function addModule(type) {
  ...
  ";
    ...
    html += '  <a href=\" data-bs-toggle=\"tooltip\" title=\"";
        // line 277
        echo ($context["button_edit"] ?? null);
        echo "\" class=\"btn btn-primary btn-sm\"><i class=\"fas fa-pencil-alt fa-fw\"></i></a><button type=\"button\" onclick=\"\$(\\'#module-row-' + module_row + '\\').remove();\" data-bs-toggle=\"tooltip\" title=\"";
        echo ($context["button_remove"] ?? null);
        echo "\" class=\"btn btn-danger btn-sm\"><i class=\"fas fa-minus-circle fa-fw\"></i></button>';
    html += '  </div></td>';
    html += '</tr>';
...
";
    ...
    {
        return new Source("", "admin/view/template/design/layout_form.twig", "/var/www/html/opencart/upload/admin/view/template/design/layout_form.twig");
    }
}
