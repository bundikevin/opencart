...
class __TwigTemplate_08641db96350a9eb8cd27d07b611e5b1 extends Template
{
    private $source;
    private $macros = [];
        ...
        echo "&store_id=' + \$('#input-store').val() + '&path=' + \$(element).attr('href'),
            ...
            success: function(json) {
                if (json['code']) {
                    ...
                    html += '    <button type=\"button\" class=\"btn btn-primary\"><i class=\"fas fa-save\"></i> ";
        // line 198
        echo ($context["button_save"] ?? null);
        echo "</button>';
                    html += '    <button class=\"btn btn-danger\"><i class=\"fas fa-recycle\"></i> ";
        // line 199
...
";
    ...
    {
        return new Source("", "admin/view/template/design/theme.twig", "/var/www/html/opencart/upload/admin/view/template/design/theme.twig");
    }
}
